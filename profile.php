...
<title>TecHeaver | Meu Perfil</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Configuracao da conta</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCESSO</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Ultima atualizacao  -</label>
            ...
            <div class="form-group">
              <label class="control-label">Seu Endereco</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Salvar Alteracao <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
