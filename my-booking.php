...
<title>TecHeaver/Minhas Reservas</title>
<!--Bootstrap -->
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>No dia:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>ate o dia:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelado</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Falta confirmar</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
