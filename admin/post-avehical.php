...
if($lastInsertId)
{
$msg="Veiculo Postado com Sucesso";
}
else 
{
...
<head>
	...
	<title>TECHeaver | Admin Posta veiculo</title>
...
<label class="col-sm-2 control-label">Selecionar Marca<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Veiculo<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Acessorio</div>
<div class="panel-body">
...
<label for="powerdoorlocks"> Travas Eletricas </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="brakeassist"> Assistencia de Freios </label>
</div>
</div>
...
<input type="checkbox" id="powersteering" name="powersteering" value="1">
<label for="inlineCheckbox5"> Direcao Hidraulica </label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="passengerairbag"> Airbag  Passageiros</label>
</div></div>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="powerwindow" name="powerwindow" value="1">
<label for="powerwindow"> Vidro Eletrico </label>
</div>
</div>
...
<label for="centrallocking">Central Travamento</label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="crashcensor" name="crashcensor" value="1">
<label for="crashcensor"> Sensor de Estacionamento </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="leatherseats" name="leatherseats" value="1">
<label for="leatherseats"> Capacidade </label>
</div>
</div>
</div>
