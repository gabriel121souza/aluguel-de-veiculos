...
$msg="Image Alterada com sucesso";
...
<head>
	...
	<title>TECHeaver/ Admin imagem alterar img</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imagem do veiculo 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Imagem e detalhes do veiculo 2</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">imagem atual</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">inserir nova imagem<span style="color:red">*</span></label>
												<div class="col-sm-8">
