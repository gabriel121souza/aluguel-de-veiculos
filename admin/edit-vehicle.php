...
<head>
	...
	<title>TECHeaver | Admin Edit Vehicle Info</title>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Informacoes Basica</div>
...
<label class="col-sm-2 control-label">Seleciona a marca<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Informacoes Veiculos<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Preco por dia(Em R$)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Selecione o tipo<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Inserir imagem 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Inserir imagem 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Inserir imagem 3</a>
</div>
</div>
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Inserir imagem 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Inserir imagem 5</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox2"> Fechadura Inteligente </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Sistema Inteligente </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Assistencia Freios </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Direcao hidraulica </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Air bags</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="driverairbag" value="1">
<label for="inlineCheckbox2">Air bag</label>
<?php } ?>
</div>
<div class="col-sm-3">
<?php if($result->DriverAirbag==1)
...
<label for="inlineCheckbox3"> Airbag Passageiros </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Sensor de Estacionamento </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Assento de couro </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
