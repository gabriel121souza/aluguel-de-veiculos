...
<head>
	...
	<title>TecnoHeaver | Admin Update Imagem 3</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imagem do veiculo 3 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Imagem do Veiculo 3 Detalhes</div>
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Inserir nova imagem 3<span style="color:red">*</span></label>
												<div class="col-sm-8">
