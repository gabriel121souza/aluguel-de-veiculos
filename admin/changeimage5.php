...
<head>
	...
	<title>TecHeaver | Admin Update Imagem 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imagem do veiculo 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Image do veiculo 5 Detalhes</div>
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Upload nova Imagem 5<span style="color:red">*</span></label>
												<div class="col-sm-8">
