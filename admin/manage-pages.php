...
$query -> execute();
$msg="Pagina alterada com  sucesso";
...
<head>
	...
	<title>TECHeaver | Admin Create Brand</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="" selected="selected" class="form-control">***Selecione***</option>
                  <option value="manage-pages.php?type=terms">termos e condicoes</option>
                  <option value="manage-pages.php?type=privacy">Politica e privacidade</option>
			...
			?>
									...
									<div class="form-group">
												<label class="col-sm-4 control-label">Pagina detalhes </label>
												<div class="col-sm-8">
