...
<head>
	...
	<title>TECHeaver |Admin Manage Subscribers   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gerenciar os Inscrito</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">detalhes Inscrito</div>
...
<a href="manage-tblcontactusquery.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
</td>
