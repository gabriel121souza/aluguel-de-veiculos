...
$query->execute();
$msg="Informacoes alterada com sucesso";
}
?>
...
<head>
	...
	<title>TecHeaver| Admin Contate no</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Altere as informacoes de contato</h2>
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Alterar</button>
												</div>
											</div>
