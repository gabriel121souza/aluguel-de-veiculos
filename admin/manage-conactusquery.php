...
$query -> execute();
$msg="orcamento excluido com sucesso";
...
<head>
	...
	<title>TECHeaver |Admin Manage orcamento   </title>
...
<a href="manage-conactusquery.php?del=<?php echo $result->id;?>" onclick="return confirm('voce quer cancelar o orcamento');"><i class="fa fa-close"></i></a>
</td>
