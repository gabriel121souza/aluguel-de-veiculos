...
<head>
	...
	<title>TECHeaver |Admin Manage Reservas  </title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">informacoes reservas</div>
...
if($result->Status==0)
{
echo htmlentities('nao confirmado');
...
echo htmlentities('confirmado');
 	...
 	echo htmlentities('confirmado');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('voce quer mesmo confirma a reserva')"> Confirmar</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('VOCE QUER MESMO CANCELAR A RESERVA')"> Cancelar</a>
</td>
