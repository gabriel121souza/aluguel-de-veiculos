...
<head>
	...
	<title>TECHeaver |Admin Manage Marcas   </title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Listar marcas</div>
...
<a href="manage-brands.php?del=<?php echo $result->id;?>" onclick="return confirm('voce quer mesmo deletar');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
