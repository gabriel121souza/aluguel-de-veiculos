...
<head>
	...
	<title>TECHeaver | Admin Update Image 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imagem do veiculo 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Imagem do veiculo 4 Detalhes</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image 4 Atual</label>
<?php  
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Upload Nova imagem 4<span style="color:red">*</span></label>
												<div class="col-sm-8">
