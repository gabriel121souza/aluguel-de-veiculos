...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>procure o melhor carro para voce <span>Para Você</span></h2>
      <p>Temos algumas variedades de veiculos.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Novo Carro</a></li>
        </ul>
      </div>
      <!-- Lista os novos carros -->
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Depoimentos <span>Recentes</span></h2>
    </div>
    <div class="row">
